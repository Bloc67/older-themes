...
<body>';
	...
	echo '
	<div id="logoarea" style="position: absolute; left: 400px; 	top: 115px; 	font-family: Georgia, serif; 	font-size: xx-large;	color: #988879;"><a style="color: #988879;" href="',$scripturl,'">', $context['forum_name']  , '</a></div>
	<table cellpadding="0" cellspacing="0" border="0" style="width:100%;" id="manu">
		<tr>
			<td valign="top" style="padding: 0; width: 243px; background: url('.$settings['images_url'].'/img/left.jpg) repeat-y;">
				<img src="'.$settings['images_url'].'/img/leftop.jpg" alt="" style="margin: 0;" />
			</td>
    		<td valign="top" style="padding: 0;width: 159px;"><img src="'.$settings['images_url'].'/img/topmid_left.jpg" alt="" style="margin: 0;" /></td>
    		<td valign="top" style="padding: 0;width: 100%; padding-top: 5px; background: url('.$settings['images_url'].'/img/topmid.jpg) repeat-x;">';
    // userarea
    ...
    echo '
    		...
    		<td height="169" valign="top" style="padding: 0;"><img src="'.$settings['images_url'].'/img/topmidright.jpg" alt="" style="margin: 0;" /></td>
    	</tr>
    	<tr>
    		<td rowspan="2" valign="top" style="padding: 0;background: url('.$settings['images_url'].'/img/lefttop2.jpg) no-repeat; padding-bottom: 30px; padding-top: 120px;" />';
	...
	theme_linktree();
	echo '<div style="overflow: hidden; margin: 0;">';
}
...
function template_main_below()
{
	...
	echo '<hr /><div class="smalltext" >', theme_copyright(), '<br /><a href="' , $settings['theme_url'] , '/license.txt"><b>Manuscript</b></a> &copy; <a target="_blank" href="http://www.blocweb.net">Blocweb</a>';
	...
	echo '
		...
		<tr>
			<td valign="top" style="padding: 0;"><img src="'.$settings['images_url'].'/img/botleft.jpg" alt="" style="margin: 0;" /></td>
			<td colspan="2" valign="top" style="padding: 0;background: url('.$settings['images_url'].'/img/bot.jpg) repeat-x;">';
			// footer
	echo '
			</td>
		</tr>
