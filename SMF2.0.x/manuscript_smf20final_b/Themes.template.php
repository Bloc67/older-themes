	...
	foreach ($context['settings'] as $setting)
	{
		...
		elseif ($setting['type'] == 'textarea')
		{
			...
			echo '
						...
						<dd>
					<textarea rows="4" style="width: 95%; height: 300px;" cols="40" name="', !empty($setting['default']) ? 'default_' : '', 'options[', $setting['id'], ']" id="', $setting['id'], '">', $setting['value'], '</textarea>
						</dd>';
		}
