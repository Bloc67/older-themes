...
function template_package_list()
{
	...
	{
		echo '
				<div class="bwgrid" style="margin-top: 2px;>';
		foreach ($context['package_list'] as $i => $packageSection)
		{
			echo '
					<div class="bwcell16">
						<h4 class="titlebg" style="margin-bottom: 10px;">', $packageSection['title'], '</h4>';
			...
			foreach ($packageSection['items'] as $id => $package)
			{
				...
				if ($package['is_text'])
					echo '<h5 class="description">', $package['name'],'</h5>';
				...
				{
					echo '<h5 class="description">', $package['link'], '</h5>';
				}
				// A title?
				...
				{
					// 1. Some mod [ Download ].
					echo '<div class="bwcell8" style="box-sizing: border-box; padding: 0 1em 1em 0;"><div class="windowbg' , $alt ? '2' : '' , '">
							<h5>', $package['can_install'] ? '<strong>' . $package['name'] . '</strong> <a href="' . $package['download']['href'] . '">[ ' . $txt['download'] . ' ]</a>': $package['name'], '</h5><hr>';


					// Show the mod type?
					if ($package['image'] != '')
						echo '
								<img src="' , $package['image'], '" alt="" style="width: 100%;" />';
					...
					echo '
								<li><a href="', $package['href'], '" title="', $package['href'], '">', $txt['file'], '</a></li>
							</ul>
							<p style="max-height: 200px; overflow: auto;">', $package['description'], '</p>
						</div></div>';
				}
				$alt = !$alt;
			}
