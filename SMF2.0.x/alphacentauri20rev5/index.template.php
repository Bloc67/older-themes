...
function template_init()
{
	...
	$settings['themecopyright'] = '<a href="https://www.bjornhkristiansen.com/smf21/index.php?board=6.0"><b>AlphaCentauri</b> &copy; 2015-2016, BHKristiansen</a>';
}
...
function template_body_below()
{
	...
	echo '<div>', $settings['themecopyright'], '</div>';
	echo '	
		</div>
	</div>';
}
...
function template_userbox()
{
	...
	if (!empty($context['current_topic']))
		echo '
						<input type="hidden" id="topic" value="', $context['current_topic'], '" />';
	// If we're on a certain board, limit it to this board ;).
	elseif (!empty($context['current_board']))
		echo '
						<input type="hidden" id="brd[', $context['current_board'], ']" value="', $context['current_board'], '" />';
