...
<div id="toplinks">';
	...
	<div id="user">
		...
		if ($context['user']['is_logged'])
		{
			echo '
				<ul>
					<li class="first">', $txt['hello_member_ndt'], ' <span>', $context['user']['name'], '</span></li>
...
function template_body_below()
{
	...
	<div id="wfooter">', theme_copyright(), '<br />
		<span class="smalltext"><b>WorkDesk2</b> design by <a href="http://www.blocweb.net">BlocWeb</a></span>
