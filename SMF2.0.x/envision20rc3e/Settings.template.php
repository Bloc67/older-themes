...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		array(
			'id' => 'onemenu',
			'label' => 'Use single menu for the forum parts',
		),
		array(
			'id' => 'rsslinks',
	...
	'',
		array(
			'id' => 'faderheight',
			'label' => 'Height of fader in pixels:',
			'type' => 'number',
		),
		array(
			'id' => 'faderwidth',
			'label' => 'Width of fader in pixels:',
			'type' => 'number',
		),
		array(
			'id' => 'faderduration',
			'label' => 'Duration of the fading in milliseconds(default: 3000):',
			'type' => 'number',
		),
		array(
			'id' => 'faderinterval',
			'label' => 'Interval between each fader item in milliseconds(default: 6000):',
			'type' => 'number',
		),
		array(
