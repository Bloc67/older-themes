...
function template_main()
{
	...
	<div id="newsfader">
		...
		<div class="mask3" style="' , !empty($settings['faderwidth']) ? 'width: '.$settings['faderwidth'].'px;' : '' , '' , !empty($settings['faderheight']) ? 'height: '.$settings['faderheight'].'px;' : '' , '"><div id="box4">
		<ul class="reset" id="smfFadeScroller"', empty($options['collapse_news_fader']) ? '' : ' style="display: none;"', '>';

			foreach ($context['news_lines'] as $news)
				echo '
			<li style="' , !empty($settings['faderwidth']) ? 'width: '.$settings['faderwidth'].'px;' : '' , '' , !empty($settings['faderheight']) ? 'height: '.$settings['faderheight'].'px;' : '' , '">
			<div style="padding: 2em; ">', $news, '</div></li>';
	...
	window.addEvent(\'domready\',function(){
		//SAMPLE 2
		var V2 = new viewer($$(\'#box4 li)\'),{
			mode: \'alpha\',
			fxOptions: {duration:' , !empty($settings['faderduration']) ? $settings['faderduration'] : '3000' , '},
			interval: ' , !empty($settings['faderinterval']) ? $settings['faderinterval'] : '6000' , '
		}).play(true);
	});
	//]]></script>
	...
	foreach ($context['categories'] as $category)
	{
		...
		if (!$category['is_collapsed'])
		{
			...
			foreach ($category['boards'] as $board)
			{
				...
				{
					echo '
				<td class="windowbg" valign="top" width="2%" style="padding: 2px;"><img style="max-height: 100%;  width: ' , !empty($settings['avatarboards_width']) ? $settings['avatarboards_width'] : '50' , 'px;" src="' . (!empty($avvy[$board['last_post']['member']['id']]) ? $avvy[$board['last_post']['member']['id']] : $settings['images_url'].'/TPguest.png') . '" alt="" /></td>';
				}
	...
	<div id="posting_icons" class="align_left">';
		...
		echo '
		<ul class="reset">
			<li class="align_left"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'on.png" style="width: 20px; max-width: 100%;" alt="" /> ', $txt['new_posts'], '</li>
			<li class="align_left"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'off.png"  style="width: 20px; max-width: 100%;" alt="" /> ', $txt['old_posts'], '</li>
			<li class="align_left"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'redirect.png"  style="width: 20px; max-width: 100%;" alt="" /> ', $txt['redirect_board'], '</li>
		</ul>
	</div>';
