...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		echo '
			...
			{
				// skip
				if(empty($settings['hideblogs']) && in_array($board['id'],$blogboards))
					continue;
				...
				if(empty($settings['no_rss']) && !$board['is_redirect'] && !empty($board['last_post']['id']))
					echo '
	...
	<div id="posting_icons" class="floatleft">';
		...
		echo '
		<ul class="reset">
			<li class="floatleft"><img src="', $settings['images_url'], '/on.png" alt="" style="width: 20px;" /> ', $txt['new_posts'], '</li>
			<li class="floatleft"><img src="', $settings['images_url'], '/off.png" alt="" style="width: 20px;" /> ', $txt['old_posts'], '</li>
			<li class="floatleft"><img src="', $settings['images_url'], '/redirect.png" style="width: 20px;" alt="" /> ', $txt['redirect_board'], '</li>
		</ul>
	</div>';
...
function template_info_center()
{
	...
	<div class="roundframe"><div class="innerframe">
		<div class="cat_bar" id="myinfocenter">
			<h3 class="catbg">
	...
	if (!empty($settings['number_recent_posts']) && (!empty($context['latest_posts']) || !empty($context['latest_post'])))
	{
			...
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						...
						',  !empty($settings['usetopics']) ? $txt['recent_topics'] : $txt['recent_posts'], '
					</span>
				</h4>
			</div>
		...
		// Show lots of posts.
		elseif (!empty($context['latest_posts']) && empty($settings['usetopics']))
		{
			echo '
		...
		elseif (!empty($context['latest_posts']) && !empty($settings['usetopics']))
		{
			...
			echo '<div style="padding: 5px;">', ssi_recentTopics() , '</div>';
		}
