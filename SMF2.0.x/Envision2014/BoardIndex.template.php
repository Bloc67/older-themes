...
function template_main()
{
	...
	{
		echo '
	<div id="newsfader" class="roundframe">
		...
		echo '
			...
			foreach ($category['boards'] as $board)
			{
				...
				if (!empty($board['last_post']['id']))
					echo '
						<br />', $txt['last_post'], '  ', $txt['by'], ' ', $board['last_post']['member']['link'] , '
						', $txt['in'], ' <b>', $board['last_post']['link'], '</b>
	...
	<div id="posting_icons" class="floatleft">';
		...
		echo '
		<ul class="reset">
			<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'on.png" style="height: 20px;" alt="" /> ', $txt['new_posts'], '</li>
			<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'off.png" style="height: 20px;" alt="" /> ', $txt['old_posts'], '</li>
			<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'redirect.png" style="height: 20px;" alt="" /> ', $txt['redirect_board'], '</li>
		</ul>
	</div>';
	...
	<div id="posting_icons" class="flow_hidden">
		<ul class="reset">
			<li class="floatleft"><img src="', $settings['images_url'], '/off.png" style="height: 20px;" alt="" /> ', $txt['old_posts'], '</li>
			<li class="floatleft"><img src="', $settings['images_url'], '/redirect.png" style="height: 20px;" alt="" /> ', $txt['redirect_board'], '</li>
		</ul>
	</div>';
	}
