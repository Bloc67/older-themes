...
<head>';
	...
	if(!empty($settings['bground']))
		echo '
<style type="text/css">
		/* over 1600 screens - newer desktops */
		@media only screen and (min-width: 1400px) {
			html {
				background: repeat-x fixed url(' , $settings['images_url'],'/backgrounds/coral' , ($settings['bground']+1) ,  '.jpg) #000  top left;
			}
		}
...
function template_body_below()
{
	...
	echo '
		...
		<footer id="footerarea">
			', theme_copyright(), ' | <a href="http://www.blocthemes.com">Coral2014 theme by blocthemes.net</a>';
