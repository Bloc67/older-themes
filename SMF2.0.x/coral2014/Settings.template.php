...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		array(
			...
			'label' =>'background',
			'vals' => array(
				0 => 'backgrounds/coral1small.jpg',
				1 => 'backgrounds/coral2small.jpg',
				2 => 'backgrounds/coral3small.jpg',
				3 => 'backgrounds/coral4small.jpg',
				4 => 'backgrounds/coral5small.jpg',
				5 => 'backgrounds/coral6small.jpg',
				6 => 'backgrounds/coral7small.jpg',
			),
		),
		array(
			'id' => 'customcopyrite',
		...
		array(
			...
			'label' => 'Twitter',
			'type' => 'social',
			'socialclass' => 'tw_button',
		),
		array(
			'id' => 'facebook',
			'label' => 'Facebook',
			'type' => 'social',
			'socialclass' => 'fb_button',
		),
		array(
			'id' => 'linkedin',
			'label' => 'LinkedIn',
			'type' => 'social',
			'socialclass' => 'ln_button',
		),
		array(
			'id' => 'box1title',
			'label' => $txt['box1title'] ,
