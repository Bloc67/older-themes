...
<form action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '"', empty($context['disable_login_hashing']) ? ' onsubmit="hashLoginPassword(this, \'' . $context['session_id'] . '\');"' : '', '>
	<div id="maintenance_mode">
		<div class="catbg">
			<h3>', $context['title'], '</h3>
			<p class="subtitle">', $txt['admin_login'], '</p>
		</div>
		<div class="plainbox">
			<img class="floatleft" src="', $settings['images_url'], '/construction.png" style="vertical-align: middle; margin: 0 2rem 0 0;" alt="', $txt['in_maintain_mode'], '" />
			', $context['description'], '
		</div>
...
function template_admin_login()
{
	...
	echo '
<script type="text/javascript" src="', $settings['default_theme_url'], '/scripts/sha1.js"></script>
<div class="togglecat" id="myhelpWin"></div>
<form action="', $scripturl, $context['get_data'], '" method="post" accept-charset="', $context['character_set'], '" name="frmLogin" id="frmLogin" onsubmit="hashAdminPassword(this, \'', $context['user']['username'], '\', \'', $context['session_id'], '\');">
	...
	echo '
			...
			<a href="', $scripturl, '?action=helpadmin;help=securityDisable_why" onclick="return myreqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.png" alt="', $txt['help'], '" /></a><br />
