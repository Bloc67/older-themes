...
function template_main()
{
	...
	<form action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '" name="searchform" id="searchform">
		<div class="catbg">
			<h3>', $txt['set_parameters'], '</h3>';

	if (!empty($context['search_errors']))
		echo '
			<p id="search_error" class="subtitle error">', implode('<br />', $context['search_errors']['messages']), '</p>';
	...
	{
		echo '
		<div class="windowbg" id="advanced_search">
			<div class="">
				<input type="hidden" name="advanced" value="1" />
				<dl id="search_options" class="settings clear">
					<dt>
						<strong>', $txt['search_for'], ':</strong>';
		if (empty($modSettings['search_simple_fulltext']))
			echo '
...
function template_results()
{
	...
	echo '
		<div class="catbg">
			...
			<span class="plainbox">',$context['search_params']['search'],'</span>
		</div>
		<div class="themepadding pagesection">
		...
		while ($topic = $context['get_topics']())
		{
			...
			foreach ($topic['matches'] as $message)
			{
				echo '
					<div>
						<span class="dark_notice floatleft" style="margin: 0 2rem 2rem 0;">', $message['counter'], '</span>
						<h4 class="largetext">', $topic['board']['link'], ' / <a href="', $scripturl, '?topic=', $topic['id'], '.msg', $message['id'], '#msg', $message['id'], '" class="largetext">', $message['subject_highlighted'], '</a></h5>
				...
				if ($message['body_highlighted'] != '')
					echo '
					<div class="clear themepadding post">', $message['body_highlighted'], '</div>';
			}
	...
	else
	{
		echo '
		<div class="catbg">
			<h3>', $txt['mlist_search_results'],':&nbsp;',$context['search_params']['search'],'</h3>
		</div>
		<div class="themepadding pagesection">
			<span>', $txt['pages'], ': ', $context['page_index'], '</span>
		</div>';
		...
		<div class="clear post">', $message['body_highlighted'], '</div>';
	...
	echo '
		<br class="clear" />
		<div class="center_align themepadding" id="search_jump_to">&nbsp;</div><br>
		<script type="text/javascript"><!-- // --><![CDATA[
