...
function template_main()
{
	...
	<div id="statistics" class="main_section">
		...
		<div class="title_bar">
			<h4 class="titlebg">', $txt['general_stats'], '
			</h4>
		</div>
	...
	echo '
		...
		<div class="flow_hidden">
			<div id="top_posters">
				<div class="title_bar">
					<h4 class="titlebg">', $txt['top_posters'], '</h4>
				</div>
					<div class="windowbg2">
						<div class="content">
							<dl class="stats">';
	...
	foreach ($context['top_posters'] as $poster)
	{
		...
		if (!empty($poster['post_percent']))
			echo '
									<div class="statsbar"><div style="width: ', $poster['post_percent'], '%;"></div>		</div>';
	...
	foreach ($context['top_boards'] as $board)
	{
		echo '
								...
								<dd>
									<span class="floatright align_right">', $board['post_percent'], '</span>
								';

		if (!empty($board['post_percent']))
			echo '
									<div class="statsbar" style="margin-right: 5rem;">
										<div style="width: ', $board['post_percent'], '%;"></div>
									</div>';
		echo '
								</dd>';
	}
	...
	foreach ($context['top_topics_replies'] as $topic)
	{
		echo '
								...
								<dd>
									<span class="floatright align_right">' . $topic['num_replies'] . '</span>
								';
		if (!empty($topic['post_percent']))
			echo '
									<div class="statsbar" style="margin-right: 5rem;">
										<div style="width: ', $topic['post_percent'], '%;"></div>
									</div>';
	...
	foreach ($context['top_topics_views'] as $topic)
	{
		echo '
							<dt>', $topic['link'], '</dt>
							<dd>
								<span class="floatright align_right">' . $topic['num_views'] . '</span>';
	...
	foreach ($context['top_starters'] as $poster)
	{
		echo '
							...
							<dd>
								<span class="floatright align_right">', $poster['num_topics'], '</span>
							';

		if (!empty($poster['post_percent']))
			echo '
								<div class="statsbar" style="margin-right: 5rem;">
									<div style="width: ', $poster['post_percent'], '%;"></div>
								</div>';
	...
	foreach ($context['top_time_online'] as $poster)
	{
		echo '
							...
							<dd>
								<span class="floatright align_right">', $poster['time_online'], '</span>
							';

		if (!empty($poster['time_percent']))
			echo '
								<div class="statsbar" style="margin-right: 5rem;">
									<div style="width: ', $poster['time_percent'], '%;"></div>
								</div>';
