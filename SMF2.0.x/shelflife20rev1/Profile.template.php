...
function template_summary()
{
	...
	echo '
<div id="profileview">
	<span class="roundavatar_profile floatright"><img src="' , $context['member']['avatar']['href'] , '" alt="',$context['member']['name'],'" /></span>
	<h3 class="blueheader">', $context['member']['name'], '</h3>
	<div class="windowbg">
		<div class="subtitle">', (!empty($context['member']['group']) ? $context['member']['group'] : $context['member']['post_group']), '<br>
			<ul class="horiz_list">';
	...
	if ($context['member']['show_email'] === 'yes' || $context['member']['show_email'] === 'no_through_forum' || $context['member']['show_email'] === 'yes_permission_override')
		echo '
				<li><a href="', $scripturl, '?action=emailuser;sa=email;uid=', $context['member']['id'], '" title="', $context['member']['show_email'] == 'yes' || $context['member']['show_email'] == 'yes_permission_override' ? $context['member']['email'] : '', '" rel="nofollow"><span class="icon-envelop">&nbsp;</span></a></li>';

	// Don't show an icon if they haven't specified a website.
	if ($context['member']['website']['url'] !== '' && !isset($context['disabled_fields']['website']))
		echo '
				<li><a href="', $context['member']['website']['url'], '" title="' . $context['member']['website']['title'] . '" target="_blank" class="new_win"><span class="icon-earth">&nbsp;</span></a></li>';
	...
	if (!empty($context['custom_fields']))
	{
		foreach ($context['custom_fields'] as $field)
			if (($field['placement'] == 1 || empty($field['output_html'])) && !empty($field['value']))
				echo '
					<li class="custom_field"><span class="icon-profile" title="', $field['output_html'], '">&nbsp;</span></li>';
	}

	echo '
				', !isset($context['disabled_fields']['icq']) && !empty($context['member']['icq']['link']) ? '<li><span class="icon-twitch">&nbsp;</span></li>' : '', '
			...
			<br><span id="userstatus">', $context['can_send_pm'] ? '<a href="' . $context['member']['online']['href'] . '" title="' . $context['member']['online']['label'] . '" rel="nofollow">' : '' , '<span class="onoff_' , $context['member']['online']['is_online'] ? 'on' : 'off' , '"></span>', $context['can_send_pm'] ? '</a>' : '', '&nbsp;&nbsp;<span class="smalltext"> ' . $context['member']['online']['text'] . '</span>';
	...
	if ($context['signature_enabled'] && !empty($context['member']['signature']))
		echo '<h5>', $txt['signature'], ':</h5>
				<div class="plainbox">', $context['member']['signature'], '</div>';
...
function template_profile_theme_settings()
{
	...
	echo '
						...
						<ul class="nolist reset" id="theme_settings">
							<li>
...
function template_profile_birthdate()
{
	...
	for($a = ($present_year - 100); $a<($present_year+1); $a++)
		echo '					<option value="' . $a . '" ', $context['member']['birth_date']['year'] == $a ? ' selected="selected"' : '' , '>' , $a , '</option>';
	...
	for($a = 1; $a<13; $a++)
		echo '					<option value="' . $a . '" ', $context['member']['birth_date']['month'] == $a ? ' selected="selected"' : '' , '>' , $txt['months_titles'][$a] , '</option>';
	...
	for($a = 1; $a<32; $a++)
		echo '					<option value="' . $a . '" ', $context['member']['birth_date']['day'] == $a ? ' selected="selected"' : '' , '>' , $a , '</option>';
...
function template_profile_avatar_select()
{
	...
	echo '
							<dt>
								<strong id="personal_picture">', $txt['personal_picture'], '</strong><hr>
	...
	{
		echo '
								<div id="avatar_server_stored" class="bwgrid">
									<div class="bwcell33"><div class="inner_right">
										<select class="fullwidth" style="margin-top: 4px;" name="cat" id="cat" size="10" onchange="changeSel(\'\');" onfocus="selectRadioByName(document.forms.creator.avatar_choice, \'server_stored\');">';
		...
		echo '
									...
									<div class="bwcell33"><div class="inner_right">
										<select  style="margin-top: 4px;" class="fullwidth" name="file" id="file" size="10" style="display: none;" onchange="showAvatar()" onfocus="selectRadioByName(document.forms.creator.avatar_choice, \'server_stored\');" disabled="disabled"><option></option></select>
									</div></div>
									<div class="bwcell33"><img name="avatar" id="avatar" src="', !empty($context['member']['avatar']['allow_external']) && $context['member']['avatar']['choice'] == 'external' ? $context['member']['avatar']['external'] : $modSettings['avatar_url'] . '/blank.gif', '" alt="Do Nothing" /></div>
									<script type="text/javascript"><!-- // --><![CDATA[
