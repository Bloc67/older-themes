	...
	<div class="', $window_class, ' clear">
		...
		<div class="bwcell14">
			...
			echo '
				...
				<ul class="horiz_list quickbuttons" style="padding-left: 0;">';
...
function template_subject_list()
{
	...
	while ($message = $context['get_pmessage']('subject'))
	{
		...
		echo '
			...
			// ]]></script>
				', $message['is_replied_to'] ? '<span class="icon-bubbles4" alt="' . $txt['pm_replied'] . '"></span>' : '<span class="icon-bubble2" alt="' . $txt['pm_read'] . '"></span>', '</td>
			<td>', $message['time'], '</td>
			<td>', ($context['display_mode'] != 0 && $context['current_pm'] == $message['id'] ? '<img src="' . $settings['images_url'] . '/selected.gif" alt="*" />&nbsp;' : ''), '<a href="', ($context['display_mode'] == 0 || $context['current_pm'] == $message['id'] ? '' : ($scripturl . '?action=pm;pmid=' . $message['id'] . ';kstart;f=' . $context['folder'] . ';start=' . $context['start'] . ';sort=' . $context['sort_by'] . ($context['sort_direction'] == 'up' ? ';' : ';desc') . ($context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : ''))), '#msg', $message['id'], '">', $message['subject'], '</a>', $message['is_unread'] ? '&nbsp;<span class="onoff_on"></span>' : '', '</td>
