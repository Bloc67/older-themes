...
function template_main()
{
	...
	<div id="posting_icons" class="floatleft">';
		...
		echo '
		<ul class="reset">
			<li class="floatleft"><img src="', $settings['images_url'], '/on.png" style="width: 20px;" alt="" />&nbsp; ', $txt['new_posts'], '</li>
			<li class="floatleft"><img src="', $settings['images_url'], '/off.png"  style="width: 20px;" alt="" />&nbsp; ', $txt['old_posts'], '</li>
