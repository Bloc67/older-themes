	...
	foreach ($context['categories'] as $category)
	{
		...
		if (!$category['is_collapsed'])
		{
			...
			foreach ($category['boards'] as $board)
			{
				...
				{
					echo '
				<td class="windowbg" valign="top" width="2%" style="padding: 2px;"><img style="max-height: 100%;  width: ' , !empty($settings['avatarboards_width']) ? $settings['avatarboards_width'] : '50' , 'px;" src="' . (!empty($avvy[$board['last_post']['member']['id']]) ? $avvy[$board['last_post']['member']['id']] : $settings['images_url'].'/none.png') . '" alt="" /></td>';
				}
