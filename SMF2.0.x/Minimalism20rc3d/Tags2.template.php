...
function template_main()
{
	...
	echo '
	<h2 class="section">',$txt['smftags_popular'], '</h2>';
	...
	echo '
	<h2 class="section">',$txt['smftags_latest'], '</h2>
  	<table class="table_grid" cellspacing="0" width="100%">
		<thead>
			<tr>
				<th class="smalltext" style="text-align: left;" scope="col">',$txt['smftags_subject'],'</th>
				<th class="smalltext" style="text-align: left;" scope="col" width="21%">',$txt['smftags_startedby'],'</th>
				<th class="smalltext" scope="col" width="4%" >',$txt['smftags_replies'],'</th>
				<th class="smalltext" scope="col" width="4%" >', $txt['smftags_views'], '</th>
			</tr>
		</thead>
		<tbody>';
	foreach ($context['tags_topics'] as $i => $topic)
	{
		echo '
			<tr>
				...
				<td class="windowbg"><a href="' . $scripturl . '?action=profile;u=' . $topic['id_member'] . '">' . $topic['poster_name'] . '</a></td>
				<td class="windowbg2">' . $topic['num_replies'] . '</td>
				<td class="windowbg2">' . $topic['num_views'] . '</td>
			</tr>';
	}
	echo '
...
function template_results()
{
	...
	echo '
	<h2 class="section">' . $txt['smftags_resultsfor'] . $context['tag_search'] . '</h2>
	<table class="table_grid" width="100%" cellspacing="0">
		<thead>
		<tr>
			<th class="smalltext" scope="col" style="text-align: left;">',$txt['smftags_subject'],'</th>
			<th class="smalltext" scope="col" style="text-align: left;" width="21%">',$txt['smftags_startedby'],'</th>
			<th class="smalltext" scope="col" style="text-align: left;" width="4%" >',$txt['smftags_replies'],'</th>
			<th class="smalltext" scope="col" width="4%" >', $txt['smftags_views'], '</th>
		</tr>
		</thead>';
	foreach ($context['tags_topics'] as $i => $topic)
