...
function template_profile_theme_settings()
{
	...
	echo '
							<li><hr /><h3>Proteus ' . $txt['mini-options'] . '</h3>
								<input type="hidden" name="default_options[recent_all]" value="0" />
								<label for="recent_all"><input type="checkbox" name="default_options[recent_all]" id="recent_all" value="1"', !empty($context['member']['options']['recent_all']) ? ' checked="checked"' : '', ' class="input_check" /> ', $txt['mini-recentall'], '</label>
							</li>
							<li>
								<input type="hidden" name="default_options[show_unreadpreview]" value="0" />
								<label for="show_unreadpreview"><input type="checkbox" name="default_options[show_unreadpreview]" id="show_unreadpreview" value="1"', !empty($context['member']['options']['show_unreadpreview']) ? ' checked="checked"' : '', ' class="input_check" /> ', $txt['mini-show_unreadpreview'], '</label>
							</li>
							<li>
								<label for="hotdate">', $txt['mini-hotdate'], '</label>
								<select name="default_options[hotdate]" id="hotdate">
									<option value="7"', !empty($context['member']['options']['hotdate']) && $context['member']['options']['hotdate'] == 7 ? ' selected="selected"' : '', '>', $txt['mini-hotdate-week'], '</option>
									<option value="30"', !empty($context['member']['options']['hotdate']) && $context['member']['options']['hotdate'] == 30 ? ' selected="selected"' : '', '>', $txt['mini-hotdate-month'], '</option>
									<option value="180"', !empty($context['member']['options']['hotdate']) && $context['member']['options']['hotdate'] == 180 ? ' selected="selected"' : '', '>', $txt['mini-hotdate-6month'], '</option>
									<option value="365"', !empty($context['member']['options']['hotdate']) && $context['member']['options']['hotdate'] == 365 ? ' selected="selected"' : '', '>', $txt['mini-hotdate-year'], '</option>
								</select>
							</li>
						</ul>
						<dl>
