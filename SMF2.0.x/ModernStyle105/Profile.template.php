...
<div id="profileview" class="flow_auto">
	<b class="smalltext greytext">', $txt['summary'], '</b>
	<div id="basicinfo">
		<div class="windowbg">
			<div class="content flow_auto">
				<div class="cat_bar">
					<h3 class="catbg">', $context['member']['name'], '<br> 
						<span class="middletext">', (!empty($context['member']['group']) ? $context['member']['group'] : $context['member']['post_group']), '</span>
					</h3></div>
				<span class="ravatar" style="background-image: url(', $context['member']['avatar']['href'], ');"></span><br>
				<ul class="reset">';
...
function template_statPanel()
{
	...
	else
	{
		...
		{
			echo '
						<li style="display: block; float: left; width: 4.1%;">
							<span class="bar"><span style="width: ' ,$time_of_day['relative_percent'] , '%;"></span></span>
							<span style="display: block; margin-top: 0.8rem;" class="smalltext">', $time_of_day['hour'], '</span>
						</li>';
		}
	...
	else
	{
		...
		{
			echo '
							<dt>', $board['link'], ' <span class="greytext">&nbsp;&nbsp;' , $board['posts'] , '</span></dt>
							<dd>
								<span class="bar"><span style="width: ' ,$board['posts_percent'] , '%;"></span></span>
							</dd>';
		}
	...
	else
	{
		...
		{
			echo '
							<dt>', $activity['link'], ' <span class="greytext">&nbsp;&nbsp;' , $activity['posts'] , '</span></dt>
							<dd>
								<span class="bar"><span style="width: ' ,$activity['posts_percent'] , '%;"></span></span>
							</dd>';
		}
...
function template_profile_theme_settings()
{
	...
	echo '
						...
						<ul id="theme_settings" class="nolist">
							<li>
...
function template_profile_avatar_select()
{
	...
	echo '
							...
							<dd style="width: 100%; display: block;  float: left; clear: both;">';
	...
	if (!empty($context['member']['avatar']['allow_server_stored']))
	{
		echo '
								<div id="avatar_server_stored" class="bwgrid">
									<div class="bwcell33">
										<select style="width: 95%;overflow: auto;" name="cat" id="cat" size="10" onchange="changeSel(\'\');" onfocus="selectRadioByName(document.forms.creator.avatar_choice, \'server_stored\');">';
		...
		echo '
									...
									<div class="bwcell33">
										<select name="file" id="file" size="10" style="width: 95%; display: none; overflow: auto; " onchange="showAvatar()" onfocus="selectRadioByName(document.forms.creator.avatar_choice, \'server_stored\');" disabled="disabled"><option></option></select>
									</div>
									<div class="bwcell33"><img name="avatar" id="avatar" src="', !empty($context['member']['avatar']['allow_external']) && $context['member']['avatar']['choice'] == 'external' ? $context['member']['avatar']['external'] : $modSettings['avatar_url'] . '/blank.gif', '" style="max-width: 100%;" alt="Do Nothing" />&nbsp;</div>
									<script type="text/javascript"><!-- // --><![CDATA[
