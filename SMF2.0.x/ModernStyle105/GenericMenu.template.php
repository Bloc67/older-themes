...
function template_generic_menu_sidebar_above()
{
	...
	echo '
	<div class="bwgrid">
		<div class="bwcell4" id="gen_menu"><div>';
	...
	foreach ($menu_context['sections'] as $section)
	{
		...
		echo '
			<div class="adm_section">
				<h4 class="catbg"><label for="toggle-' , $section['id'] , '">', $section['title'],'</label></h4>
				<input type="checkbox" id="toggle-' , $section['id'] , '" class="checkHide">
				<ul class="nolist">';
...
function template_generic_menu_tabs(&$menu_context)
{
	...
	<p class="windowbg description">', !empty($selected_tab['description']) ? $selected_tab['description'] : $tab_context['description'], '</p>
	<div id="adm_submenus">
		<ul class="dropmenu">';
