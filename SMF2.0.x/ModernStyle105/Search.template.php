		...
		echo '
			<div class="roundframe">
				...
				<div class="enhanced">
					<strong>', $txt['search_for'], ':</strong>
					<div>
						<input type="text" style="width: 95%;" name="search"', !empty($context['search_params']['search']) ? ' value="' . $context['search_params']['search'] . '"' : '', ' maxlength="', $context['search_string_limit'], '" size="40" class="input_text" />
		...
		if (empty($context['search_params']['topic']))
		{
			...
			<div class="roundframe">
				...
				<div class="flow_auto" id="searchBoardsExpand"', $context['boards_check_all'] ? ' style="display: none;"' : '', '>
					<ul class="ignoreboards floatleft nolist">';
		...
		foreach ($category['boards'] as $board)
		{
			if ($i == $limit)
				echo '
					...
					<ul class="ignoreboards floatright nolist">
						<li class="category">
							<ul>';
...
function template_results()
{
	...
	echo '
		...
		<div class="pagesection">
			', convertpages($context['page_index']), '
		</div>';
