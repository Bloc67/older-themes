...
function template_main()
{
	...
	echo '
		<div id="calendar">
			<div class="bwgrid">
				<div class="bwcell33"><div class="minical">', template_show_month_grid('prev'), '</div></div>
				<div class="bwcell33"><div class="minical">', template_show_month_grid('current'), '</div></div>
				<div class="bwcell33"><div class="minical">', template_show_month_grid('next'), '</div></div>
			</div><br>
			<div id="main_grid" class="clear">
...
function template_show_month_grid($grid_name)
{
	...
	if (empty($calendar_data['disable_title']))
	{
		...
		if (empty($calendar_data['previous_calendar']['disabled']) && $calendar_data['show_next_prev'])
			echo '
					<span class="floatleft"><a href="', $calendar_data['previous_calendar']['href'], '"><span class="icon-left"></span></a></span>';

		if (empty($calendar_data['next_calendar']['disabled']) && $calendar_data['show_next_prev'])
			echo '
					<span class="floatright"><a href="', $calendar_data['next_calendar']['href'], '"><span class="icon-right"></span></a></span>';
	...
	echo '
				<table cellspacing="1" class="calendar_table" style="width: 100%;">';
	...
	foreach ($calendar_data['weeks'] as $week)
	{
		...
		if (!empty($calendar_data['show_week_links']))
			echo '
						<td class="windowbg2 weeks" style="text-align: center; ">
							<a href="', $scripturl, '?action=calendar;viewweek;year=', $calendar_data['current_year'], ';month=', $calendar_data['current_month'], ';day=', $week['days'][0]['day'], '"><span class="icon-calendar"></span></a>
						</td>';
