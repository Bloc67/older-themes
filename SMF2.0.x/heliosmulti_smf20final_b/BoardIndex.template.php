...
function template_main()
{
	...
	if (!empty($settings['number_recent_posts']))
	{
		echo '
			...
			<div class="hslice windowbg" id="recent_posts_content" style="padding: 8px;">
		...
		if ($settings['number_recent_posts'] == 1)
		{
			...
			echo '
				...
				<p id="infocenter_onepost" class="middletext" style="padding: 8px;">
	...
	if ($context['show_calendar'])
	{
		echo '
			...
			<div class="smalltext windowbg" style="padding: 8px;">';
	...
	if ($context['user']['is_logged'] && !$settings['show_stats_index'])
	{
		echo '
			...
			<div class="pminfo windowbg" style="padding: 8px;">
