...
{
	global $context, $settings, $options, $txt, $scripturl, $modSettings, $db_prefix, $smcFunc;
	...
	echo '
				<span class="mypages">', $txt['pages'], ': ', $context['page_index'], '</span>
			</div>';
		...
		echo '
			<div class="tborder topic_table" id="unread">
				<table class="table_grid" cellspacing="0">
					<thead>
						<tr class="catbg">
						<th scope="col" class="smalltext first_th" colspan="1">&nbsp;</th>
	...
	foreach ($context['topics'] as $topic)
	{
		...
		echo '
			...
			echo '		<div style="padding: 4px 0;">
							', $topic['is_sticky'] ? '<strong>' : '', '<a ' , !empty($settings['showmootips']) ? ' class="tipz"' : '' , ' title="'.$mootip.'" href="', $topic['first_post']['href'], '">'.$topic['first_post']['subject'].'</a>', $topic['is_sticky'] ? '</strong>' : '' ,'
