...
function template_main()
{
	...
	<div id="posting_icons" class="floatleft">';
		...
		echo '
		<ul class="reset">
			<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'on.png" style="width: 20px;" alt="" />&nbsp; ', $txt['new_posts'], '</li>
			<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'off.png"  style="width: 20px;" alt="" />&nbsp; ', $txt['old_posts'], '</li>
			<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'redirect.png"  style="width: 20px;" alt="" />&nbsp; ', $txt['redirect_board'], '</li>
		</ul>
	</div>';
