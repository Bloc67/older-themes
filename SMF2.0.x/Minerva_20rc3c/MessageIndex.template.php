...
<div class="tborder" id="childboards">
	...
	<div class="table_frame">
		...
		foreach ($context['boards'] as $board)
		{
			...
			{
				echo '
				<td class="windowbg" valign="top" width="2%" style="padding: 2px;"><img style="height: ' , !empty($settings['avatarboards_height']) ? $settings['avatarboards_height'] : '60' , 'px;  width: ' , !empty($settings['avatarboards_width']) ? $settings['avatarboards_width'] : '60' , 'px;" src="' . (!empty($avvy[$board['last_post']['member']['id']]) ? $avvy[$board['last_post']['member']['id']] : $settings['images_url'].'/TPguest.png') . '" /></td>';
			}
	...
	<form action="', $scripturl, '?action=quickmod;board=', $context['current_board'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" class="clear" name="quickModForm" id="quickModForm">';
		...
		foreach ($context['topics'] as $topic)
		{
			...
			if(!empty($settings['messagepreview']) && empty($settings['messagepreview_last']))
				echo '
						<div class="messpreview">&#171;', $topic['first_post']['preview'] , '&#187;</div>';
			elseif(!empty($settings['messagepreview']) && !empty($settings['messagepreview_last']))
				echo '
						<div class="messpreview">&#171;', $topic['last_post']['preview'] , '&#187;</div>';
			...
			if(!empty($settings['avatarboards']))
				echo '
						<a href="', $topic['last_post']['href'], '"><img src="' . (!empty($avvy[$topic['last_post']['member']['id']]) ? $avvy[$topic['last_post']['member']['id']] : $settings['images_url'].'/TPguest.png') . '" style="margin: 5px;float: right;width: 35px; height: 35px;" alt="" /></a>';
			else
