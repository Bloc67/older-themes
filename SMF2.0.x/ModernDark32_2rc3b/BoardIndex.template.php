...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		if (!$category['is_collapsed'])
		{
			...
			foreach ($category['boards'] as $board)
			{
				...
				{
					echo '
				<td class="windowbg" valign="top" width="2%" style="padding: 2px;"><img style="height: ' , !empty($settings['avatarboards_height']) ? $settings['avatarboards_height'] : '60' , 'px;  width: ' , !empty($settings['avatarboards_width']) ? $settings['avatarboards_width'] : '60' , 'px;" src="' . (!empty($avvy[$board['last_post']['member']['id']]) ? $avvy[$board['last_post']['member']['id']] : $settings['images_url'].'/none.png') . '" alt="" /></td>';
				}
	...
	<div id="posting_icons" class="align_left">';
		...
		echo '
		<ul class="reset">
			<li class="align_left"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'on.png" style="width: 20px; height: 20px;" alt="" /> ', $txt['new_posts'], '</li>
			<li class="align_left"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'off.png"  style="width: 20px; height: 20px;" alt="" /> ', $txt['old_posts'], '</li>
			<li class="align_left"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'redirect.png"  style="width: 20px; height: 20px;" alt="" /> ', $txt['redirect_board'], '</li>
		</ul>
	</div>';
