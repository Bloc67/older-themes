...
<body>
	<div id="midframe">
		<div id="rightframe">
			<div id="leftframe">
				<div id="bot">
					<div id="botright">', template_menu() ,'
	<h1 id="forumname"><a href="'.$scripturl.'"><img src="'.$settings['images_url'].'/theme/logo.png" alt="'.$context['forum_name'].'" /></a></h1>' ;
}
...
function template_body_above()
{
	...
	<div style="float: right;"><form id="search_form" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '">
		<input type="text" name="search" value="" id="searchtext" style="width: 145px; border: none; background: none;" />
		<input type="submit" name="submit" value="&nbsp;" id="searchsubmit" style="width: 30px; border: none; background: none; cursor: pointer;" />
	...
	<div style="padding: 1em; margin: 0; min-height: 120px;">';
	
	// Show a random news item? (or you could pick one from news_lines...)
	if (!empty($settings['enable_news']))
		echo '
	<div id="qnews"><b>', $txt['news'], ': </b><br>', $context['random_news_line'], '</div>';
	...
	if ($context['user']['is_logged'])
	{
		if (!empty($context['user']['avatar']))
			echo '
			<p class="myavatar">', $context['user']['avatar']['image'], '</p>';
		echo '
			<ul class="reset">
				<li class="greeting"><b>', $txt['hello_member_ndt'], ' <span>', $context['user']['name'], '</span></b></li>
...
function template_body_below()
{
	...
	echo '
	<div class="smalltext"><b>Pandora</b> design by <a href="http://www.blocweb.net">BlocWeb</a></div>';
