...
function template_main()
{
	...
	<div id="statistics" class="main_section">
		...
		<div class="bwgrid">
			<div class="bwcell8">
				<div class="bwgutter_right">
					<div class="title_bar">
						<h4 class="titlebg">
							', $txt['general_stats'], '
						</h4>
					</div>
					<dl class="settings stat_settings">
	...
	foreach ($context['stats_blocks'] as $name => $block)
	{
		...
		foreach ($block as $item)
		{
			...
			if (!empty($item['percent']))
				echo '	<span class="floatright">', $item['num'], '</span>
							<div style="margin: 0 8rem 0 2rem;">
								<span class="backline">
									<span class="percentline" style="width: ' , $item['percent'] , '%;"></span>
									<span class="rightcircle" style="left: ' , $item['percent'] , '%;"></span>
								</span>
							</div>';
			else
				echo '
							<div class="floatright">', $item['num'], '</div>';
