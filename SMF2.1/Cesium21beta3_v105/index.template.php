...
function template_init()
{
	...
	$settings['themecopyright'] = '<a href="https://www.bjornhkristiansen.com/smf21/"><b>Cesium</b> theme by Bloc &copy; 2017</a>';
...
<head>
	...
	loadCSSFile('cesium.css', array('minimize' => true), 'bloc_cesium');
...
function template_body_above()
{
	...
	if ($context['user']['is_logged'])
	{
		...
		echo '
					<ul class="floatright nolist dropmenu des">
						<li>
	...
	else
	{
		if (empty($maintenance))
			echo '
					<ul class="floatright nolist dropmenu mob_clear">
	...
	echo '
					<div class="floatright floatpop mob">
	...
	{
		echo '	
					<div id="fq_search" class="floatright floatpop des">	
	...
	if(function_exists('template_generic_menu'))
		echo '	
						<div class="floatright clear_right"><span class="icon-menu mob icon-bigger" onclick="fPop_toggle(\'#admenu\'); return false;"></span></div>';			
	
	if ($context['user']['is_logged'])
		echo '
					<div class="mob floatleft" style="opacity: 0.5; margin: 0.5rem 0 0 0;">' , $txt['hello_guest'] , ' ' , $context['user']['name'] , '</div>';

	echo '		<br class="clear">		
					<div class="des clear">' , template_menu() , '</div>
				</div>
