...
function template_main()
{
	...
	{
		if(!empty($settings['use_'.$g]) && !empty($settings[$g.'_boards']) && in_array($context['current_board'], explode(',',$settings[$g.'_boards'])))
		{
			echo '<div class="infobox">', $txt['ces_values_'.$g],'</div>';
		}
	}	
	...
	if (!empty($modSettings['additional_options_collapsable']))
		echo '
					<div id="postAdditionalOptionsHeader">
						<strong><span class="icon-toggleme"></span>&nbsp;<a href="#" id="postMoreExpandLink"> ', $context['can_post_attachment'] ? $txt['post_additionalopt_attach'] : $txt['post_additionalopt'], '
						</a></strong>
					</div>';
	...
	if ($context['can_post_attachment'])
	{
			...
			echo '
						<div class="files" id="au-previews">
							<div id="au-template">
								<div class="attach-info bwgrid"><hr>
									<div class="bwcell8">
										<img data-dz-thumbnail /><br>
										<span class="name" data-dz-name></span>
										<span class="error" data-dz-errormessage></span>
										<span class="size" data-dz-size></span>
										<span class="message" data-dz-message></span>
									</div>
									<div class="attached_BBC bwcell8">
										...
										<div class="attach-ui" style="padding-top: 1rem;">
		...
		echo '	
						<div id="postAttachment2">';


		echo '			<div class="cat_bar">
								<h3 class="catbg">', $txt['attach'], '</h3>
							</div>
							<div class="toppadding">
								<div id="attachUpload" class="largetext descbox">
									<h5 class="information" style="opacity: 0.5; margin-bottom: 1rem;">', $txt['attach_drop_zone'] ,'</h5>
									<a class="button_submit" id="attach-cancelAll">', $txt['attached_cancelAll'] ,'</a>
									<a class="button_submit" id="attach-uploadAll" style="font-weight: bold;">', $txt['attached_uploadAll'] ,'</a>
