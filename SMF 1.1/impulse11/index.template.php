...
function template_default_below()
{
	...
	<div id="footersection">
		<span class="left"></span>
		<span class="right"></span>
		<div class="content"><div id="copywrite">' , theme_copyright() , function_exists('tportal_version') ? '<div>' . tportal_version() . '</div>' : '' , '<br /><strong>imPulse</strong> theme by <a href="http.//www.blocweb.net">BlocWeb</a></div></div>
	</div>';
