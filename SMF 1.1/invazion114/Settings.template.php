...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		array(
			'id' => 'invazionlogo',
			'label' => 'What background on topframe',
			'options' => array(
				'logo1.jpg' => 'Logo 1',
				'logo2.jpg' => 'Logo 2',
			),
			'bar' => 'Invazion settings',
		),
		array(
			'id' => 'forumwidth',
			'label' => 'Width of forum',
			'type' => 'text',
		),
		array(
			'id' => 'disallow_categorytabs',
			'label' => 'Do not allow users to choose to show boards and categories as tabs?',
		),
		array(
			'id' => 'disallow_userpics',
			'label' => 'Do not allow users to show extra pictures in profile?',
		),
		array(
			'id' => 'disallow_userbio',
			'label' => 'Do not allow users to show user description in profile?',
		),
		array(
			'id' => 'off_infocenter',
			'label' => 'Turn off Info Center?',
		),
		array(
			'id' => 'show_recenttopics',
			'label' => 'Show Recent topics between board and Info Center?',
		),
		array(
			'id' => 'show_oldprofile',
			'label' => 'Do not use the new profile summary screen?',
		),
		array(
			'id' => 'but1_name',
			'label' => 'Custom button 1 - name',
			'type' => 'text',
			'bar' => 'Extra buttons',
		),
		array(
		...
		array(
			'id' => 'but5_link',
			'label' => 'Custom button 5 - link',
			'type' => 'text',
		),

		array(
			'id' => 'use_tp',
			'label' => 'Support for TinyPortal mod?',
			'bar' => 'Support for mods',
		),
		array(
			'id' => 'use_arcade',
			'label' => 'Support for SMF Arcade mod?',
		),
		array(
			'id' => 'use_shoutbox',
			'label' => 'Support for Ultimate Shoutbox mod?',
		),
		array(
			'id' => 'use_smfgallery',
			'label' => 'Support for SMF Gallery Lite mod?',
		),
		array(
			'id' => 'use_ads',
			'label' => 'Support for Ad Management mod?',
		),
		array(
			'id' => 'use_gb',
			'label' => 'Support for Googlebots & Spiders mod?',
		),
		array(
			'id' => 'use_ga',
			'label' => 'Support for Global Announcements mod?',
		),
		array(
			'id' => 'use_shop',
			'label' => 'Support for SMF Shop mod?',
		),
		array(
			'id' => 'custom_pages',
			'label' => 'Custom pages',
			'description' => 'use the form: file[.template],title,type where type can be 1.) page or 2.) link. Use "link" for a regular link, "page" for a custom template file. ',
			'type' => 'textarea',
			'empty' => 'homepage,News,page|about,Custom,page|http://www.tinyportal.net,TP,link',
		),
		array(
