...
function template_main()
{
	...
	{
			echo  '
			<h3 style="margin: 0; padding: 5px;" class="catbg">' . $txt['parent_boards'] . '</h3>
	...
	<form action="', $scripturl, '?action=quickmod;board=', $context['current_board'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" name="quickModForm" id="quickModForm" style="margin: 0;">';
		...
		foreach ($context['topics'] as $topic)
		{
			...
			if($topic['is_sticky'])
			{
				...
				{
					echo '<tr><td width="100%" colspan="' , !empty($options['display_quick_mod']) ? '8' : '7' , '"><div class="titlebg" style="padding: 6px;">', $txt['meph_sticky'], '</div></td></tr>';
					$first_sticky=true;
					$rendered=true;
				}
		...
		echo '<tr><td width="100%" colspan="' , !empty($options['display_quick_mod']) ? '8' : '7' , '"><div class="titlebg" style="padding: 6px;">', $txt['meph_normal'], '</div></td></tr>';
		// then the non-sticky
		foreach ($context['topics'] as $topic)
		{
			if(!$topic['is_sticky'])
	...
	echo '<br />
	<div class="tborder">
		<table cellpadding="8" cellspacing="0" width="100%" style="border-top: solid 2px #666;">
			<tr>';
