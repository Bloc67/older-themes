...
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="tborder" style="border-bottom: 0;">
	...
	echo '
<form action="', $scripturl, '?action=quickmod2;topic=', $context['current_topic'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" name="quickModForm" id="quickModForm" style="margin: 0; padding: 0;" onsubmit="return in_edit_mode == 1 ? modify_save(\'' . $context['session_id'] . '\') : confirm(\'' . $txt['quickmod_confirm'] . '\');">';
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bordercolor">';
	...
	<tr><td style="padding: 1px 1px 0 1px;">';
		...
		echo '
		<h4 class="catbg headertitle">', !empty($message['counter']) ? ' #' . $message['counter'] : '' , ' <a href="', $message['href'], '">', $message['subject'], '</a></h4>
		...
		if (!$message['member']['is_guest'])
		{
			...
			if(!empty($message['member']['options']['invazionskype'])) 
				echo '<a href="callto://', $message['member']['options']['skype'], '/">
							<img src="' . $settings['images_url'] . '/skype.gif">
						</a><br />';
...
// Show the profile, website, email address, and personal message buttons.
		...
		echo '
									<div class="smalltext"> ', $message['time'], ' </div></td>
