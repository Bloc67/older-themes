...
function template_main()
{
	...
	echo '
		...
		if (!isset($context['old_search']))
			echo '
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td class="smalltext">', $txt[139], ': ', $context['page_index'], '</td>
						<td align="right" class="smalltext">', $context['letter_links'] . '</td>
					</tr>
				</table>';
		...
		<tr class="', empty($settings['use_tabs']) ? 'titlebg' : 'catbg3', '"><td colspan="12"><div class="bigblue">';
	...
	echo '
		<tr>
			<td colspan="12" class="modbutton">', $txt[139], ': ', $context['page_index'], '</td>
		</tr>
	</table>';
...
function template_search()
{
	...
	echo '
		...
		<div class="viewbutton" align="center" style="padding-bottom: 1ex;">
