...
<body>';
	...
	echo '<div id="mainframe"><div class="innerframe">';
	...
	if((!empty($settings['use_tp']) && $context['TPortal']['showtop']) || empty($settings['use_tp']))
		echo '<div id="user" ', empty($options['collapse_header']) ? '' : ' style="display: none;"', '><div id="user_inner">', userarea() , '</div></div>';
...
function template_main_below()
{
	...
	echo '
								<div>
									...
									' , !empty($settings['use_tp']) ? tportal_version().'<br />' : '' , '
									<strong>BlueSkies</strong> design by <a href="http.//www.blocweb.net" target="_blank">BlocWeb</a> |
...
function template_button_strip($button_strip, $direction = 'top', $force_reset = false, $custom_td = '')
{
	...
	if (empty($button_strip))
		return '<td>&nbsp;</td>';
	$mid='<img style="top: -5px; position: relative;margin: 0 10px 0 10px;" align="middle" src="'.$settings['images_url'].'/divide.gif" alt="" />';
	echo '
