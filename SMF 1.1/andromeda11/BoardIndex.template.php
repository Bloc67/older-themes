	...
	<div class="tborder" style="margin-top: ' , $first ? '0;' : '1ex;' , '' , $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? 'width: 100%;' : '', '">
		...
		<table border="0" width="100%" cellspacing="1" cellpadding="5" class="bordercolor" style="margin-top: 1px;">';
			...
			<tr>
				...
				if ($board['new'])
					echo '<img src="', $settings['images_url'], '/theme', $context['browser']['is_ie6'] ? 'ie6' : '' ,'/on.' , $context['browser']['is_ie6'] ? 'gif' : 'png' , '" alt="', $txt[333], '" title="', $txt[333], '" />';
				// This board doesn't have new posts, but its children do.
				elseif ($board['children_new'])
					echo '<img src="', $settings['images_url'], '/theme', $context['browser']['is_ie6'] ? 'ie6' : '' ,'/on2.' , $context['browser']['is_ie6'] ? 'gif' : 'png' , '" alt="', $txt[333], '" title="', $txt[333], '" />';
				// No new posts at all! The agony!!
				else
					echo '<img src="', $settings['images_url'], '/theme', $context['browser']['is_ie6'] ? 'ie6' : '' ,'/off.' , $context['browser']['is_ie6'] ? 'gif' : 'png' , '" alt="', $txt[334], '" title="', $txt[334], '" />';
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="5">
		<tr>
			<td align="', !$context['right_to_left'] ? 'left' : 'right', '" class="smalltext">
				<img src="' . $settings['images_url'] . '/theme/on.png" style="width: 20px; height: 20px;" alt="" align="middle" /> ', $txt[333], '
				<img src="' . $settings['images_url'] . '/theme/on2.png" alt="" align="middle" style="width: 20px; height: 20px;"  /> ', $txt[334], '
			</td>
