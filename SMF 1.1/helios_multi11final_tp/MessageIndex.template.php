...
function template_main()
{
        ...
        echo $leftbox.'
                <table width="100%" cellpadding="3" cellspacing="0">
                        <tr>
                                <td align="left"><a name="top"></a>', theme_linktree(), '</td>';
        ...
        {
                echo '
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="tborder" style="margin-bottom: 1ex;">
                        <tr>
...
', (!empty($topic['quick_mod']['remove']) ? '<img src="'.$settings['images_url'].'/icons/modify_inline2.gif" align="right" alt="" onclick="modify_topic(\'' . $topic['id'] . '\', \'' . $topic['first_post']['id'] . '\', \'' . $context['session_id'] . '\');" />' : ''), '
                ...
                {
                        echo '
                                        <td class="windowbg" valign="middle" align="center" nowrap="nowrap">';
        ...
        echo '
         ...
         echo $topbox.'<div style="padding: 10px; margin-top: 5px; margin-bottom: 5px;">
