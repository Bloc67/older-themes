	...
	<div class="tborder" style="margin-top: ' , $first ? '0;' : '1ex;' , '' , $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? 'width: 100%;' : '', '">
		...
		<table border="0" width="100%" cellspacing="1" cellpadding="5" class="bordercolor" style="margin-top: 1px;">';
			...
			<tr class="catbg3">
				...
				<td>', $txt[22], '</td>
				<td align="center">', $txt[330], '</td>
				<td align="center">', $txt[21], '</td>
			</tr>';
					$once=false;
				}
				echo '
			<tr>
				<td class="windowbg" width="2%" align="center" valign="middle"><a href="', $scripturl, '?action=unread;board=', $board['id'], '.0">';
				...
				<td class="windowbg2" valign="middle" align="center" width="10%"><small>
					', $board['topics'],'</small>
				</td>
				<td class="windowbg" valign="middle" align="center" width="10%"><small>
					', $board['posts'], '</small>
				</td>
			</tr>';
