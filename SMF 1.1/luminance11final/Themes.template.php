	...
	echo '
				...
				<tr class="catbg">
					<td colspan="2"><img src="', $settings['images_url'], '/icons/config_sm.gif" alt="" align="top" /> ', $txt['theme6'], '</td>
                                                               ...
                                                               <tr class="windowbg2"><td colspan="2"><hr size="1" /></td></tr>
                               <tr class="windowbg2">
                                        <td>Topbox : (use your own HTML code)</td><td><textarea cols="70" rows="5" name="options[topbar]">' , isset($context['theme_settings']['topbar']) ? $context['theme_settings']['topbar'] : '' , '</textarea></td>
                                </tr>
                               <tr class="windowbg2">
                                        <td>Bottombox : (use your own HTML code)</td><td><textarea cols="70" rows="5" name="options[botbar]">' , isset($context['theme_settings']['botbar']) ? $context['theme_settings']['botbar'] : '' , '</textarea></td>
                                </tr>
                               <tr class="windowbg2">
                                        <td>width of forum:</td><td><input type="text" name="options[mywidth]" value="' , isset($context['theme_settings']['mywidth']) ? $context['theme_settings']['mywidth'] : '' , '"></td>
                                </tr>
                                  <tr class="windowbg2"><td colspan="2"><hr size="1" /></td></tr>';
