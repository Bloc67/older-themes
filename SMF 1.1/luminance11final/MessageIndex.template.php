...
function template_main()
{
	...
	<div class="tborder" style="margin-bottom: 3ex; ', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? ' width: 100%;' : '', '">
		...
		foreach ($context['boards'] as $board)
		{
			...
			echo '
				...
				<td class="windowbg2" valign="middle" width="28%"><small>';
			...
			if (!empty($board['last_post']['id']))
				...
				<td class="windowbg" valign="middle" align="center" style="width: 5ex;"><small>
					', $board['topics'],'</small>
				</td>
				<td class="windowbg" valign="middle" align="center" style="width: 5ex;"><small>
					', $board['posts'], '</small>
				</td>
				<td class="windowbg" width="6%" align="center" valign="middle"><a href="', $scripturl, '?action=unread;board=', $board['id'], '.0">';
			...
			if (!empty($board['children']))
			{
				...
				echo '
			<tr>
				<td colspan="5" class="windowbg', !empty($settings['seperate_sticky_lock']) ? '3' : '', '" style="padding-left: 2ex;">
				<img src="'.$settings['images_url'].'/childs.gif" alt="" />
	...
	if (!empty($options['show_board_desc']) && $context['description'] != '')
	{
		...
		<table width="100%" cellpadding="6" cellspacing="1" border="0" class="tborder" style="padding: 0; margin-bottom: 2ex;">
			<tr>
				<td class="titlebg2" id="descript" width="100%" height="24" style="border-top: 0;">
	...
	<form action="', $scripturl, '?action=quickmod;board=', $context['current_board'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" name="quickModForm" id="quickModForm" style="margin: 0;">';
		...
		{
			echo '
					<tr class="windowbg2" id="descript2">
		...
		if (!empty($options['display_quick_mod']) && $options['display_quick_mod'] == 1 && !empty($context['topics']))
		{
			echo '
					<tr class="catbg">
						<td colspan="8" align="right" id="descript3">
	...
	echo '
	<div class="tborder">
		<table cellpadding="8" cellspacing="0" width="100%" class="titlebg2" id="descript4">
			<tr>';
