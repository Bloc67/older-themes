...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array(
			'id' => 'use_tp',
			'label' => 'Support for TinyPortal 0.9.8 mod? (full panel support, extra button suppport)',
		),
		array(
			'id' => 'use_arcade',
			'label' => 'Support for SMF Arcade 2.0.8 mod? (extra button suppport)',
		),
		array(
			'id' => 'use_shoutbox',
			'label' => 'Support for Ultimate Shoutbox mod? (full panel support)',
		),
		array(
			'id' => 'use_smfgallery',
			'label' => 'Support for SMF Gallery Lite mod? (extra button suppport)',
		),
		array(
			'id' => 'use_ads',
			'label' => 'Support for Ad Management 2.3 mod? (full panel support)',
		),
		array(
			'id' => 'use_gb',
			'label' => 'Support for Googlebots & Spiders 2.0.3 mod? (information line suppport)',
		),
		array(
			'id' => 'use_shop',
			'label' => 'Support for SMF Shop 3.0 mod? (extra button suppport)',
		),
		array(
			'id' => 'custom_pages',
			'label' => 'Custom pages',
