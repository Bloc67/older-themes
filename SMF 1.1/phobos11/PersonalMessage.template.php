		...
		echo '<br />
			<table width="100%" border="0" cellpadding="0" cellspacing="0"><tr>
				<td width="180" valign="top">
					' . $settings['greybox1'] . '<table border="0" cellpadding="4" cellspacing="1" class="bordercolor" width="140">';
...
<form action="', $scripturl, '?action=pm;sa=pmactions;f=', $context['folder'], ';start=', $context['start'], $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', '" method="post" accept-charset="', $context['character_set'], '" name="pmFolder">
	' . $settings['titlebg1'] . '<table border="0" width="100%" cellpadding="0" cellspacing="0">
		<tr>
	...
	<table border="0" width="100%" cellpadding="2" cellspacing="1" class="bordercolor" style="margin-left: 10px;">';
	...
	<div class="bordercolor" style="padding: 1px; ', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? 'width: 100%;' : '', '">
		<table width="100%" cellpadding="2" cellspacing="0" border="0"><tr class="titlebg" valign="middle">
	...
	if ($context['get_pmessage'](true))
	{
		...
		$quote_button = create_button('quote.gif', 145, '', '');
		$reply_button = create_button('im_reply.gif', 146, '', '');
		$reply_all_button = create_button('im_reply_all.gif', 'reply_to_all', '', '');
		$forward_button = create_button('quote.gif', 145, '', '');
		$delete_button = create_button('delete.gif', 154, '', '');
		...
		while ($message = $context['get_pmessage']())
		{
			...
			echo '
										...
										<input style="vertical-align: top;" type="checkbox" name="pms[]" id="deletedisplay', $message['id'], '" value="', $message['id'], '" class="check" onclick="document.getElementById(\'deletelisting', $message['id'], '\').checked = this.checked;" />
		...
		echo '
			...
			echo '
			<h4 style="padding-bottom: 5px; margin-bottom: 8px; border-bottom: solid 1px #999;">', $message['member']['link'], '</h4>';
		...
		echo '<h3 style="margin-bottom: 8px;">', $message['subject'], '</h3>
		<p>', $message['body'], '</p>
		</div>
		'. $settings['greybox2'] . '</div>';
		}

		echo '</div>
	<div class="tborder" style="clear: both; padding: 1px; margin-top: 1ex;">
