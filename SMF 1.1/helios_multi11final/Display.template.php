...
function template_main()
{
        ...
        $leftbox='<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td valign="top" style="height: 54px; width: 72px;"><img alt="gfx" src="'.$settings['images_url'].'/pod/'.$options['theme_color'].'/pod-board-lefttop.gif" style="height: 54px; width: 72px; border: 0px; padding: 0px; margin: 0px;" /></td><td style="text-align: center; height: 54px; background-image: url('.$settings['images_url'].'/pod/'.$options['theme_color'].'/pod-board-midtop.gif); ">';
...
<a name="msg', $context['first_message'], '"></a>', $context['first_new_message'] ? '<a name="new"></a>' : '';
        ...
        echo $leftbox.'<div style="padding-top: 8px;">
<table width="100%" cellpadding="3" cellspacing="0" align="left">
        <tr>
                <td align="left" valign="bottom" style="padding-left: 0px;">', theme_linktree(), '</td>
        </tr>
</table></div>'.$rightbox;

        echo '<div style="padding-right: 25px; width: 99%; text-align: right;" class="smalltext">';
        ...
        echo '<div style="padding-left: 0px; padding-right: 0px; margin-top: 4px;">';
        // Is this topic also a poll?
        if ($context['is_poll'])
        {
                echo '<div style="padding-left: 10px; padding-right: 10px; padding-bottom: 5px;">
<table cellpadding="5" cellspacing="0" border="0" width="100%" class="tborder" style="margin-bottom: 2ex;">
        <tr class="titlebg">
                <td colspan="2" valign="middle" align="left" style="padding-left: 6px;">
                        <img src="', $settings['images_url'], '/topic/', $context['poll']['is_locked'] ? 'normal_poll_locked' : 'normal_poll', '.gif" alt="" align="middle" /> ', $txt['smf43'], '
                </td>
        </tr>
        <tr class="windowbg">
...
<table cellpadding="3" cellspacing="0" border="0" width="100%" class="tborder" style="margin-bottom: 2ex;">
	...
	echo '
        ...
        echo '<div style="padding-left: 10px; padding-right: 10px; padding-bottom: 0px;">
...
<table><tr><td valign="top" style="padding-right: 10px;">', theme_show_mod_buttons();
...
<script language="JavaScript1.2" type="text/javascript" src="' . $settings['default_theme_url'] . '/spellcheck.js"></script>';
                ...
                echo '
<a name="quickreply"></a>
<div style="padding-left: 30px; padding-right: 30px; margin-top: 5px;">
<table border="0" cellspacing="1" cellpadding="3" class="bordercolor" width="100%" style="clear: both;">
	...
	<tr id="quickReplyOptions"', $options['display_quick_reply'] == 2 ? '' : ' style="display: none"', '>
		...
		if ($context['show_spellchecking'])
                ...
                if ($context['show_spellchecking'])
                        echo '
<form name="spell_form" id="spell_form" method="post" accept-charset="', $context['character_set'], '"  target="spellWindow" action="', $scripturl, '?action=spellcheck"><input type="hidden" name="spell_formname" value="" /><input type="hidden" name="spell_fieldname" value="" /><input type="hidden" name="spellstring" value="" /></form>';
