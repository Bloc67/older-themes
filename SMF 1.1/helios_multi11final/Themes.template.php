	...
	echo '
				...
				<tr class="catbg">
					<td colspan="2"><img src="', $settings['images_url'], '/icons/config_sm.gif" alt="" align="top" /> ', $txt['theme6'], '</td>
                               ...
                               <tr class="windowbg2">
                                        <td>Topbar : (use your own HTML code)</td><td><textarea cols="70" rows="5" name="options[topbar]">' , isset($context['theme_settings']['topbar']) ? $context['theme_settings']['topbar'] : '' , '</textarea></td>
                                </tr>
                               <tr class="windowbg2">
                                        <td>Logo :</td><td><input type="text" name="options[userlogo]" value="' , isset($context['theme_settings']['userlogo']) ? $context['theme_settings']['userlogo'] : '' , '" size="50" /></td>
                                </tr>
                                  <tr class="windowbg2"><td colspan="2"><hr size="1" /></td></tr>';
