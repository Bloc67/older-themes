...
function template_main()
{
	...
	<div class="tborder" style="margin-top: ' , $first ? '0;' : '1ex;' , '' , $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? 'width: 100%;' : '', '">
		...
		<table border="0" width="100%" cellspacing="1" cellpadding="5" class="bordercolor" style="margin-top: 1px;">
			<tr class="titlebg2" style="font-size: 85%; color: #ddd;">
				<td colspan="2">' . $txt[20] . '</td>
				<td>' . $txt[331] . '</td>
				<td>' . $txt[21] . '</td>
				<td' , !empty($settings['avatarboards']) ? ' colspan="' . (!empty($settings['rsslink']) ? '4' : '3') . '"' : ' colspan="' . (!empty($settings['rsslink']) ? '3' : '2') . '"' , '>' . $txt[22] . '</td>
			</tr>';
