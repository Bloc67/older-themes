...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bordercolor">';
	...
	<tr><td style="padding: 1px 1px 0 1px;">';
		...
		{
			echo '
								<div style="overflow: auto;"><fieldset style="border: solid 1px #888; padding: 1em; "><legend style="font-style: italic; padding: 0 8px; font-weight: bold;">Attachments</legend>
									';
	...
	if(!empty($settings['area1_where']) && $settings['area1_where']==3)
		echo '<div class="windowbg3" style="padding: 8px; ">', $settings['area1'], '</div>';
	elseif(!empty($settings['area1_where']) && $settings['area1_where']==2 && $first)
		echo '<div class="windowbg3" style="padding: 8px; ">', $settings['area1'], '</div>';
	
	if(!empty($settings['area2_where']) && $settings['area2_where']==3)
		echo '<div class="windowbg3" style="padding: 8px; ">', $settings['area2'], '</div>';
	elseif(!empty($settings['area2_where']) && $settings['area2_where']==2 && $first)
		echo '<div class="windowbg3" style="padding: 8px; ">', $settings['area2'], '</div>';
	
	if(!empty($settings['area3_where']) && $settings['area3_where']==3)
		echo '<div class="windowbg3" style="padding: 8px; ">', $settings['area3'], '</div>';
	elseif(!empty($settings['area3_where']) && $settings['area3_where']==2 && $first)
		echo '<div class="windowbg3" style="padding: 8px; ">', $settings['area3'], '</div>';
