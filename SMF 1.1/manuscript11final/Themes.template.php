...
function template_main()
{
	...
	if ($context['can_create_new'])
		echo '
				...
				<tr class="windowbg2">
					<td style="padding-left: 20%;"><input type="file" name="theme_gz" id="theme_gz" value="theme_gz" size="40" onchange="this.form.copy.disabled = this.value != \'\'; this.form.theme_dir.disabled = this.value != \'\';" /></td>
				</tr>';
	...
	echo '
				...
				<tr class="windowbg2">
					<td style="padding-left: 20%;"><input type="text" name="theme_dir" id="theme_dir" value="', $context['new_theme_dir'], '" size="40" style="width: 70%;" /></td>
				</tr>';
	...
	if ($context['can_create_new'])
		echo '
				...
				<tr class="windowbg2">
					<td style="padding-left: 20%;"><input type="text" name="copy" id="copy" value="', $context['new_theme_name'], '" size="40" /></td>
				</tr>';
...
function template_list_themes()
{
	...
	echo '
		...
		<form action="', $scripturl, '?action=theme;sesc=', $context['session_id'], ';sa=list" method="post">
...
function template_set_options()
{
	...
	echo '
		<form action="', $scripturl, '?action=theme;th=', $context['theme_settings']['theme_id'], ';sa=reset" method="post">
...
function template_set_settings()
{
	...
	echo '
		<form action="', $scripturl, '?action=theme;sa=settings;th=', $context['theme_settings']['theme_id'], '" method="post">
			<table border="0" width="80%" cellspacing="0" cellpadding="4" align="center" class="tborder">
				<tr class="titlebg">
					<td colspan="2"><a href="', $scripturl, '?action=helpadmin;help=theme_settings" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" border="0" align="top" /></a> ', $txt['theme4'], ' - ', $context['theme_settings']['name'], '</td>
				</tr>';
	...
	foreach ($context['settings'] as $setting)
	{
		...
		{
			echo '
					<textarea rows="4" cols="40" name="', !empty($setting['default']) ? 'default_' : '', 'options[', $setting['id'], ']" id="', $setting['id'], '">', $setting['value'], '</textarea>
					<br /><label for="', $setting['id'], '">', $setting['label'], '</label>';
		}
		else
			echo '
					<label for="', $setting['id'], '">', $setting['label'], '</label>
