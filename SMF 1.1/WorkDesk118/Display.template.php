...
<table cellpadding="3" cellspacing="0" border="0" width="100%" class="tborder2" style="padding-top: 0;">
	<tr>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-bottom: 0;">
	...
	{
		echo '<div class="row1" style="padding: 1em;">';
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">';
	...
	<tr><td style="padding: 1px 1px 0 1px;">';
		...
		if ($context['can_reply'] && !empty($options['display_quick_reply']))
			echo '
					<a href="', $scripturl, '?action=post;quote=', $message['id'], ';topic=', $context['current_topic'], '.', $context['start'], ';num_replies=', $context['num_replies'], ';sesc=', $context['session_id'], '" onclick="doQuote(', $message['id'], ', \'', $context['session_id'], '\'); return false;"><img src="'.$settings['images_url'].'/theme/reply.png" alt="" title="'.$txt[145].'" /></a>';

		// So... quick reply is off, but they *can* reply?
		elseif ($context['can_reply'])
			echo '
					<a href="', $scripturl, '?action=post;quote=', $message['id'], ';topic=', $context['current_topic'], '.', $context['start'], ';num_replies=', $context['num_replies'], ';sesc=', $context['session_id'], '"><img src="'.$settings['images_url'].'/theme/reply.png" alt="'.$txt[145].'" title="'.$txt[145].'" /></a>';

		// Can the user modify the contents of this post?
		if ($message['can_modify'])
			echo '
					<a href="', $scripturl, '?action=post;msg=', $message['id'], ';topic=', $context['current_topic'], '.', $context['start'], ';sesc=', $context['session_id'], '"><img src="'.$settings['images_url'].'/theme/modify.png" alt="'.$txt[66].'" title="'.$txt[66].'" /></a>';

		// How about... even... remove it entirely?!
		if ($message['can_remove'])
			echo '
					<a href="', $scripturl, '?action=deletemsg;topic=', $context['current_topic'], '.', $context['start'], ';msg=', $message['id'], ';sesc=', $context['session_id'], '" onclick="return confirm(\'', $txt[154], '?\');"><img src="'.$settings['images_url'].'/theme/delete.png" alt="'.$txt[121].'" title="'.$txt[121].'" /></a>';
		...
		if ($context['can_split'])
			echo '
					<a href="', $scripturl, '?action=splittopics;topic=', $context['current_topic'], '.0;at=', $message['id'], '"><img src="'.$settings['images_url'].'/theme/split.png" alt="'.$txt['smf251'].'" title="'.$txt['smf251'].'" /></a>';
		...
		echo '
							...
							' . $settings['greybox1'] . '
							<div class="post"', $message['can_modify'] ? ' id="msg_' . $message['id'] . '"' : '', ' style="padding: 10px 10px 0 10px;">', $message['body'], '', $message['can_modify'] ? '
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 1ex;">
	...
	echo $settings['titlebg1']. '
<div class="tborder2"><div align="', !$context['right_to_left'] ? 'right' : 'left', '">
