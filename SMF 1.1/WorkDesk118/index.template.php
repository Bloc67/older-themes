...
function template_init()
{
	...
	<div class="greybox_midl"><div class="greybox_midr">';
	$settings['greybox2'] = '</div></div></div></div></div>
...
<body>
	<div class="bot"><div class="left"><div class="right"><div class="top"><div class="botright"><div class="botleft"><div class="topright"><div class="topleft">
		<div id="url">' , $baseurl , '</div>
...
function template_main_below()
{
	...
	echo '
		...
		<div id="footerarea">
			', theme_copyright(), '
			<div class="smalltext"><strong>WorkDesk</strong> design by <a href="http.//www.blocweb.net">BlocWeb</a></div>';
...
function topmenu()
{
	...
	$first =true;
	echo '
	<ul id="topmenu" style="overflow: hidden;">';
	foreach($context['sitemenu'] as $menu => $val)
	{
		if($val[2]=='page')
			$buts[] = '<li><a ' . ($first ? 'class="first" ' : '') . 'href="'.$scripturl.'?action='.$val[0].'">'.$val[1].'</a></li>';
		elseif($val[2]=='link')
			$buts[] = '<li><a ' . ($first ? 'class="first" ' : '') . 'href="'.$val[0].'">'.$val[1].'</a></li>';
		$first=false;
	}
	echo implode("",$buts) , '</ul>';
}
