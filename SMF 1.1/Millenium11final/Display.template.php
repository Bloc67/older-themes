...
<a name="msg', $context['first_message'], '"></a>', $context['first_new_message'] ? '<a name="new"></a>' : '';
	...
	<div class="category">
		<h1>', $txt['smf43'], '</h1>
		<div class="modbutton" style="font-weight: normal;"><b>', $txt['smf21'], ':</b>
			<p>
	...
	if (!empty($context['linked_calendar_events']))
	{
		echo '
		<div class="category">
			<h1>', $txt['calendar_linked_events'], '</h1>
			<div class="modbutton">
				<ul>';
	...
	echo '
		<div class="viewbutton" style="background: #f0f5f6; overflow: hidden; margin-top: 0;">
			<div style="float: left;">', $txt[139], ': ', $context['page_index'], !empty($modSettings['topbottomEnable']) ? $context['menu_separator'] . ' &nbsp;&nbsp;<a href="#lastPost"><b>' . $txt['topbottom5'] . '</b></a>' : '', '
			</div>
			<div class="nav" style="float: right;"> ', $context['previous_next'], '</div>
		</div>
		<div class="modbutton" style="margin-top: 1ex; text-align: right;">
					', template_button_strip_mill($normal_buttons, 'bottom'), '
		</div>';

	// Show the topic information - icon, subject, etc.
	echo '
	<div class="category"><img align="right" src="', $settings['images_url'], '/topic/', $context['class'], '.gif" align="" alt="" />
				<h1  id="top_subject">', $txt[118], ': ', $context['subject'], ' &nbsp;(', $txt[641], ' ', $context['num_views'], ' ', $txt[642], ')
				</h1>
	</div>';
	if (!empty($settings['display_who_viewing']))
	{
		echo '
		<div class="viewbutton" style="margin-top: 0;">';
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bordercolor">';
	...
	{
		echo '
	<tr><td style="padding: 1px 1px 0 1px; border-bottom: dotted 2px #b0b0b0;">';
...
<a name="lastPost"></a>';
	...
	echo '
		<div class="viewbutton" style="background: #f0f5f6; overflow: hidden; margin-top: 0;">
			<div style="float: left;">', $txt[139], ': ', $context['page_index'], !empty($modSettings['topbottomEnable']) ? $context['menu_separator'] . ' &nbsp;&nbsp;<a href="#top"><b>' . $txt['topbottom4'] . '</b></a>' : '', '
			</div>
			<div style="float: right;"> ', $context['previous_next'], '</div>
		</div>
		<div class="modbutton" style="margin-top: 1ex; text-align: right;">
					', template_button_strip_mill($normal_buttons, 'top',true), '
		</div>';
...
// ]]></script>';
	...
	echo '
			<div class="viewbutton" style="background: #f0f0f8; margin-top: 0; text-align: right">', template_button_strip_mill($mod_buttons, 'bottom') , '</div>';
	...
	echo '
<div class="tborder"><div style="padding: 4px;" align="', !$context['right_to_left'] ? 'right' : 'left', '">
