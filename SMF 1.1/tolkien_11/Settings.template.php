...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		array(
			'id' => 'use_tp',
			'label' => 'Support for TinyPortal 0.9.8 mod?',
		),
		array(
			'id' => 'use_arcade',
			'label' => 'Support for SMF Arcade 2.0.8 mod?',
		),
		array(
			'id' => 'use_shoutbox',
			'label' => 'Support for Ultimate Shoutbox 1.40 mod?',
		),
		array(
			'id' => 'use_smfgallery',
			'label' => 'Support for SMF Gallery Lite 1.7.4 mod?',
		),
		array(
			'id' => 'use_ads',
			'label' => 'Support for Ad Management 2.3 mod?',
		),
		array(
			'id' => 'use_gb',
			'label' => 'Support for Googlebots & Spiders 2.0.3 mod?',
		),
		array(
			'id' => 'use_ga',
			'label' => 'Support for Global Announcements 1.0 mod?',
		),
		array(
			'id' => 'use_shop',
			'label' => 'Support for SMF Shop 3.0 mod?',
		),
		array(
			'id' => 'custom_pages',
			'label' => 'Custom pages',
		...
		array(
			'id' => 'customhtml',
			'label' => 'Custom HTML',
			'description' => 'NB! Not used when TinyPortal is active!',
			'type' => 'textarea',
			'empty' => 'Write your own HTML here in this area!',
		),
		array(
