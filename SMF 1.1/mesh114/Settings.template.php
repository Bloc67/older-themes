...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array(
			'id' => 'mytopbox',
			'label' => 'HTML area on top',
			'description' => 'Use any HTML code in this box and it will show over the whole forum. Make it empty to dissappear.',
			'type' => 'textarea',
		),
		array(
			'id' => 'mybannerbox',
			'label' => 'HTML area in the middle',
			'description' => 'Use any HTML code in this box and it will show over the navigation tree. Make it empty to disappear.',
			'type' => 'textarea',
		),
		array(
			'id' => 'disallow_width',
			'label' => 'Disallow your users to change the width?',
		),
		array(
			'id' => 'site_width',
			'label' => 'Set the width for users:',
			'type' => 'text',
		),
		array(
			'id' => 'header_logo_url',
