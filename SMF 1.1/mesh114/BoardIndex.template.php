...
function template_main()
{
	...
	<table cellpadding="0" cellspacing="0">
		...
		echo '
			...
			<td><img src="',$settings['images_url'],'/catbg_end.jpg" alt="" /></td>
		</tr>
	</table>';
		...
		<table border="0" width="100%" cellspacing="1" cellpadding="5" class="bordercolor" style="font-size: smaller; margin-top: 1px;">';
			...
			foreach ($category['boards'] as $board)
			{
				echo '
			<tr>
				<td ' , !empty($board['children']) ? 'rowspan="2"' : '' , ' class="smalltext" width="6%" align="center" valign="top"><a href="', $scripturl, '?action=unread;board=', $board['id'], '.0">';
				...
				<td valign="top">
					<b><a href="', $board['href'], '" name="b', $board['id'], '">', $board['name'], '</a></b><br /><span class="smalltext">
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="5">
		<tr>
			<td align="', !$context['right_to_left'] ? 'left' : 'right', '" class="smalltext">
				<img src="' . $settings['images_url'] . '/new_some.gif" alt="" /> ', $txt[333], '
				<img src="' . $settings['images_url'] . '/new_none.gif" alt="" style="margin-left: 4ex;" /> ', $txt[334], '
			</td>
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td><img src="',$settings['images_url'],'/catbg_first.jpg" alt="" /></td>
