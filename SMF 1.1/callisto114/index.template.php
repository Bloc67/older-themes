...
<html xmlns="http://www.w3.org/1999/xhtml"', $context['right_to_left'] ? ' dir="rtl"' : '', '><head>
	...
	if($context['browser']['is_ie6'])
		echo '
	<link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/styleIE6.css?fin11" />';
	...
	body
	{
		background: url(' , $settings['images_url'] , '/img/background/' , !empty($settings['bgpicture']) ? $settings['bgpicture'] : 'forest.jpg' , ') repeat-x;
	}
	 --></style>';
...
<div id="backframe">
	...
	echo ' <div id="content"><div id="content_botm">
							<div id="content_botl">
								<div id="content_botr">
										<div id="content_topr">
											<div id="content_topl"></div>';
	
	if((!empty($settings['use_tp']) && $context['TPortal']['showtop']) || empty($settings['use_tp']))
		echo '
							<div class="innerpads" id="user" ', empty($options['collapse_header']) ? '' : ' style="display: none;"', '>', userarea() , '	</div>
							<div>';
	theme_linktree2();
...
function template_main_below()
{
	...
	echo '
								...
								<strong>Callisto</strong> design by <a href="http.//www.blocweb.net" target="_blank">BlocWeb</a> |
...
// TinyPortal integrated bars
	...
	echo '
							<td width="', $sidebar ? '80%' : '100%' , '" align="left" valign="top" style="padding-top: 15px; padding-bottom: 10px;" id="bodyarea">';
