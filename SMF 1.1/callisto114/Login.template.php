...
function template_login()
{
	...
	echo '
		...
		<form action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '" name="frmLogin" id="frmLogin" style="margin-top: 4ex;"', empty($context['disable_login_hashing']) ? ' onsubmit="hashLoginPassword(this, \'' . $context['session_id'] . '\');"' : '', '>
			<table border="0" width="400" cellspacing="0" cellpadding="4" class="tborder" align="center">
				<tr>
					<td colspan="2">
						' . $settings['titlebg1'] . '<img src="', $settings['images_url'], '/icons/login_sm.gif" alt="" align="top" /> ', $txt[34], '
					' . $settings['titlebg2'] . '</td>';
	...
	echo '
		<table border="0" width="400" cellspacing="0" cellpadding="4" align="center"><tr><td>
			' . $settings['greybox1']. '
			<table border="0" width="100%" cellspacing="0" cellpadding="4" class="tborder" style="padding: 10px;" align="center">
				<tr class="windowbg">
	...
	echo '
			...
			</table>' . $settings['greybox2'] . '</td></tr></table>
