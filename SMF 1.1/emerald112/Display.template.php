...
echo '<div style="padding: 0.5em; text-align: ', !$context['right_to_left'] ? 'right' : 'left', ';" > ', $context['previous_next'], '</div>';
	...
	echo 	template_button_strip_tp($normal_buttons, 'bottom'), '
	<div class="middletext" style="padding: 1em;">', $txt[139], ': ', $context['page_index'], !empty($modSettings['topbottomEnable']) ? $context['menu_separator'] . ' &nbsp;&nbsp;<a href="#lastPost"><b>' . $txt['topbottom5'] . '</b></a>' : '', '</div>';
...
<a name="lastPost"></a>';
	...
	echo '<div style="padding: 1em" class="middletext">', $txt[139], ': ', $context['page_index'], !empty($modSettings['topbottomEnable']) ? $context['menu_separator'] . ' &nbsp;&nbsp;<a href="#top"><b>' . $txt['topbottom4'] . '</b></a>' : '', '
			</div>' , template_button_strip_tp($normal_buttons, 'top', true);
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 1ex;">
	...
	echo '
				<td valign="top" align="', !$context['right_to_left'] ? 'right' : 'left', '" > ', $context['previous_next'], '</td>
		</tr>
</table>';
	...
	echo template_button_strip_tp($mod_buttons, 'bottom');
	...
	echo '
<div class="tborder"><div class="" style="padding: 4px;" align="', !$context['right_to_left'] ? 'right' : 'left', '">
