...
function template_main()
{
	...
	<div class="tborder" style="margin-bottom: 3ex; ', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? ' width: 100%;' : '', '">
		<table border="0" width="100%" cellspacing="0" cellpadding="5" class="bordercolor">
			<tr>
				<td colspan="5" class="titlebg">', $txt['parent_boards'], '</td>
			</tr>';
		...
		foreach ($context['boards'] as $board)
		{
			echo '
			<tr>
				<td ' , !empty($board['children']) ? 'rowspan="3"' : '' , ' class="windowbg" width="6%" align="center" valign="top"><a href="', $scripturl, '?action=unread;board=', $board['id'], '.0">';
			...
			echo '
				...
				<td class="windowbg" valign="middle" align="center" style="width: 9ex;">
					', $board['posts'], '
				</td>
				<td class="windowbg" valign="middle" align="center" style="width: 9ex;">
					', $board['topics'],'
				</td>
				<td class="windowbg2" valign="middle" width="25%"><small>';
	...
	{
		echo '
		<table width="100%" cellpadding="6" cellspacing="1" border="0" class="tborder" style="background: url('.$settings['images_url'].'/machine.jpg); padding: 0; margin-bottom: 2ex;">
			<tr>
				<td class="titlebg2" width="100%" height="24" style="background: none; border-top: 0;">
	...
	{
		echo '
		<table width="100%" cellpadding="0" cellspacing="0" border="0" class="myborder">
			<tr>
			...
			if (!empty($options['display_quick_mod']))
			{
				...
				else
				{
					...
					if ($topic['quick_mod']['remove'])
						echo '<a href="', $scripturl, '?action=quickmod;board=', $context['current_board'], '.', $context['start'], ';actions[', $topic['id'], ']=remove;sesc=', $context['session_id'], '" onclick="return confirm(\'', $txt['quickmod_confirm'], '\');"><img src="', $settings['images_url'], '/icons/quick_remove.gif" alt="', $txt[63], '" title="', $txt[63], '" /></a>';

					if ($topic['quick_mod']['lock'])
						echo '<a href="', $scripturl, '?action=quickmod;board=', $context['current_board'], '.', $context['start'], ';actions[', $topic['id'], ']=lock;sesc=', $context['session_id'], '" onclick="return confirm(\'', $txt['quickmod_confirm'], '\');"><img src="', $settings['images_url'], '/icons/quick_lock.gif" alt="', $txt['smf279'], '" title="', $txt['smf279'], '" /></a>';

					if ($topic['quick_mod']['lock'] || $topic['quick_mod']['remove'])
						echo '<br />';

					if ($topic['quick_mod']['sticky'])
						echo '<a href="', $scripturl, '?action=quickmod;board=', $context['current_board'], '.', $context['start'], ';actions[', $topic['id'], ']=sticky;sesc=', $context['session_id'], '" onclick="return confirm(\'', $txt['quickmod_confirm'], '\');"><img src="', $settings['images_url'], '/icons/quick_sticky.gif" alt="', $txt['smf277'], '" title="', $txt['smf277'], '" /></a>';

					if ($topic['quick_mod']['move'])
						echo '<a href="', $scripturl, '?action=movetopic;board=', $context['current_board'], '.', $context['start'], ';topic=', $topic['id'], '.0"><img src="', $settings['images_url'], '/icons/quick_move.gif"  alt="', $txt[132], '" title="', $txt[132], '" /></a>';
				}
				echo '</td>';
			}
			echo '
	...
	echo '
	<div class="tborder">
		<table cellpadding="8" cellspacing="0" width="100%" style="color: #909090; background: url('.$settings['images_url'].'/machine.jpg)">
			<tr>';
