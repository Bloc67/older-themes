...
function template_main()
{
	...
	{
		echo '
	<div style="height: 67px; background: url('.$settings['images_url'].'/machine.jpg) repeat-x;">';
	...
	{
		echo '
	<table cellpadding="0" cellspacing="0" width="100%"><tr><td style="background: url('.$settings['images_url'].'/catbg.gif) repeat-x;">' ,$category['can_collapse'] ? '<a href="'. $category['collapse_href']. '">' : '' , '<img src="'.$settings['images_url'].'/' , $category['is_collapsed'] ? 'on.gif' : 'off.gif' , '" alt="" />' ,$category['can_collapse'] ? '</a>' : '' , '</td><td nowrap="nowrap"  style="background: url('.$settings['images_url'].'/catbg.gif) repeat-x;">';
		echo '<b>'.$category['link'].'</b>';
		echo '</td><td width="99%" style="background: url('.$settings['images_url'].'/catbglongbg.gif) repeat-x;"><img src="',$settings['images_url'],'/catbglong.jpg" alt="" /></td></tr>
	<tr><td colspan="4">';
		...
		{
			echo '
		<table border="0" width="100%" cellspacing="0" cellpadding="5" style="margin-top: 1px;">';
	...
	{
		echo '
	<table border="0" width="100%" cellspacing="0" cellpadding="5" class="myborder">
		<tr>
