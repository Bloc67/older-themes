...
<div class="tborder" style="margin-bottom: 2ex;">
	...
	foreach ($context['categories'] as $category)
	{
		...
		if (!$category['is_collapsed'])
		{
			...
			{
				echo '<div class="boardpadding">' . $context['box2a']. '
	...
	<tr >
		<td width="6%" align="center" valign="top"><a href="', $scripturl, '?action=unread;board=', $board['id'], '.0">';
				...
				elseif ($board['children_new'])
					echo '<img src="', $settings['images_url'], '/img/on2.jpg" alt="', $txt[333], '" title="', $txt[333], '" border="0" />';
		...
		{
			echo '
				<td class="windowbg" ', $board['is_redirect'] && $modSettings['redirect_hide_columns'] ? ' colspan="2"' : '' , '>
		...
		if(!empty($settings['use_redirect']))
		{
			if(!$board['is_redirect'] || !$modSettings['redirect_hide_columns'])
			{
				if(!$board['is_redirect'])
				{
					...
					echo '
						<td  class="windowbg" colspan="2" align="center">Redirected</td>';
			}
		}
		else
			echo '
		...
		echo '
				<td class="windowbg smalltext" valign="middle" width="26%">';
...
<div class="tborder" style="padding: 3px;"><table border="0" width="100%" cellspacing="0" cellpadding="5">
	<tr >
		<td align="', !$context['right_to_left'] ? 'left' : 'right', '" class="smalltext" style="padding-left: 40px;">
		...
		if ($settings['show_mark_read'] && !empty($context['categories']))
			echo template_button_strip($mark_read_button, 'top');
	...
	echo '
<br />
' . $context['box1a'] . '<div class="tborder"><table border="0" width="100%" cellspacing="1" cellpadding="4">
	<tr>
