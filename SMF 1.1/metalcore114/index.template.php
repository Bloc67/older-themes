...
function template_init()
{
	...
	// overide TP images setting
	$settings['tp_images_url'] = $settings['images_url'];
...
function template_main_above()
{
	...
	// define the boxes
	$context['box1a'] = '<div class="box1mid"><div class="box1end"><div class="box1start">';
	$context['box1b'] = '</div></div></div>';
	...
	<div class="box2right">
		<div class="box2left">
			<div class="box2bottom">
				<div class="box2top">
	<div class="box2topright">
		<div class="box2topleft">
			<div class="box2bottomright">
				<div class="box2bottomleft">';
	$context['box2b'] = '
	</div>
		</div>
			</div>
...
<div id="mainframe">
	<div id="logo"></div>
	<div id="time">
		<form class="smalltext greytext" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '" style="margin: 0 0 8px 0;">
...
echo '
	...
	{
		echo '<span class="smalltext greytext">', $txt['hello_member_ndt'], ' <b>', $context['user']['name'], '</b>';

		// Only tell them about their messages if they can read their messages!
		if ($context['allow_pm'])
			echo ' <a href="', $scripturl, '?action=pm">PM: ', $context['user']['messages'], ' / ', $context['user']['unread_messages'];
		...
		echo '
						<a href="', $scripturl, '?action=unread">', $txt['metalcore3'], '</a>
						<a href="', $scripturl, '?action=unreadreplies">', $txt['metalcore2'], '</a>
				</span>';
	}
	...
	else
	{
		echo '
						...
						<script language="JavaScript" type="text/javascript" src="', $settings['default_theme_url'], '/sha1.js"></script>
							<form class="smalltext greytext" action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '" style="margin: 3px 1ex 1px 0;"', empty($context['disable_login_hashing']) ? ' onsubmit="hashLoginPassword(this, \'' . $context['session_id'] . '\');"' : '', '>
							<div style="margin-bottom: 5px;">
									...
									<input type="submit" value="', $txt[34], '" />', $txt['smf52'], '
...
template_menu();
	...
	echo '
			<div id="innerframe2" style="clear: both;">		
	...
	{
		echo '					<td width="' ,$context['TPortal']['leftbar_width'], '" style="padding: ' , isset($context['TPortal']['padding']) ? $context['TPortal']['padding'] : '4' , 'px; padding-top: 4px;padding-right: 1ex;" valign="top">' , $context['box1a'] , '
...
function template_main_below()
{
	...
	{
		echo '					<td width="' ,$context['TPortal']['rightbar_width'], '" style="padding: ' , isset($context['TPortal']['padding']) ? $context['TPortal']['padding'] : '4' , 'px; padding-top: 4px;padding-right: 1ex;" valign="top">' , $context['box1a'] , '
	...
	echo '
			<div id="footerarea">
				', theme_copyright(), ' 
					<div class="smalltext"><b>Metalcore</b> design by <a href="http.//www.blocweb.net">BlocWeb</a> ';
