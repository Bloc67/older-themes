...
<div style="text-align: center; font-size: x-small; float: right; padding: 10px;"><img style="border: solid 1px #888;" src="<?php echo $settings['images_url'] ?>/png/escher.jpg" alt="" />
