...
function template_main()
{
	...
	echo '<div class="cat"><div class="catl"><div class="catr">
			</div></div></div>';

	if (isset($context['boards']) && (!empty($options['show_children']) || $context['start'] == 0))
	{
		echo '
	<div class="mpad" style="margin-bottom: 3ex; ', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? ' width: 100%;' : '', '">
	...
	{
		echo '
		<table width="100%" cellpadding="6" cellspacing="1" border="0" class="mpad" style="padding: 0; margin-bottom: 2ex;">
			<tr>
	...
	{
		echo '
		<table width="100%" cellpadding="0" cellspacing="0" border="0" class="mpad">
			<tr>
	...
	<form action="', $scripturl, '?action=quickmod;board=', $context['current_board'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" name="quickModForm" id="quickModForm" style="margin: 0;">';
		...
		echo '
			<div class="mpad" ', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? 'style="width: 100%;"' : '', '>
		...
		foreach ($context['topics'] as $topic)
		{
			...
			echo '
						...
						<td class="windowbg2" valign="middle" width="30%">
