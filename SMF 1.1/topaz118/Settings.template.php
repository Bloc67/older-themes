...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array(
			'id' => 'tpmenu1',
			'label' => 'Menu 1 from TinyPortal',
			'type' => 'menulist',
		) : array(
			'id' => 'tpmenu1',
			'label' => 'Menu 1',
			'description' => 'Separate menu items like this: <b>link|title</b> , <b>link|title</b>',
			'type' => 'text',
		)  ,		
		array(
			'id' => 'use_menu1',
		...
		array(
			'id' => 'top_slogan',
			'label' => 'Top slogan text:',
			'type' => 'text',
			'bar' => true,
		),
		array(
			'id' => 'slogan_title',
			'label' => 'Title for slogan text upper right:',
			'description' => '<b>Only for the SMF version!</b>',
			'type' => 'text',
		) ,		
		array(
			'id' => 'slogan_text',
			'label' => 'Slogan text upper right:',
			'description' => '<b>Only for the SMF version!</b>',
			'type' => 'textarea',
		)  ,		
		array(
		...
		array(
			'id' => 'own_globe',
			'label' => 'Use your own image:',
			'description' => 'Leave the field empty in order to use the preset images.',
			'type' => 'text',
		),
		array(
			'id' => 'site_color',
		...
		array(
			'id' => 'centerpanel_tabs',
			'label' => 'Show upper panel blocks as tabs?',
		),
		array(
